...
public class HistoriaUserDesignPatternsActivity extends AppCompatActivity {

    private static final String TAG="HistoriaUserActivity";
    CalendarView kalendarzUser;
    private RecyclerView kalendarzUserrecyclerview;
    private HistoriaUserDesignPatternsAdapter historiaUserDesignPatternsAdapter;
    //private LoginActivity loginActivity;
    private List<RezerwacjaDesignPatterns> historiaUserList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        historiaUserDesignPatternsAdapter=new HistoriaUserDesignPatternsAdapter(this,historiaUserList);
        kalendarzUserrecyclerview.setHasFixedSize(true);
        kalendarzUserrecyclerview.setLayoutManager(new LinearLayoutManager(this));
        kalendarzUserrecyclerview.setAdapter(historiaUserDesignPatternsAdapter);
        firebaseFirestore=FirebaseFirestore.getInstance();

        String email1=singleton.pokazEmail();
                        ...
                        if(e!=null){
                            ...
                            for (DocumentChange documentChange:queryDocumentSnapshots.getDocumentChanges()){
                                if(documentChange.getType()==DocumentChange.Type.ADDED){
                                    ...
                                    historiaUserDesignPatternsAdapter.notifyDataSetChanged();
                                }
                            }
                        }
                    }
